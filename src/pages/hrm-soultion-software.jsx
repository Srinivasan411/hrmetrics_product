...
export default function HrmSoultionSoftwarePage() {
  ...
  return (
    <div>
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              <div className="site-heading mb-0 text-center">
                ...
                <p className="split-text">With HRM Mitra's flexible platform, streamline every process—from onboarding and attendance to payroll and performance reviews. Each module adapts to your organisation's unique structures and policies. Fully automated with integrated
      ...
      <div className="project-style-three-area" id="software1">
        <div className="container-fluid">

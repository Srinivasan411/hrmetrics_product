export default function PrivacyPolicyPage() {
  return (
    <div>
      ...
      <div className="breadcrumb-area bg-cover shadow theme-hard text-center text-light" style={{backgroundImage: 'url("../assets/images/privacy-policy.webp")'}}>
        <div className="container">
          <div className="row">
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              <h4>9. Contact Us</h4>
              <p>If you have any questions or concerns regarding your privacy or our data practices, please reach out to our support team at <a href="mailto:info@hrmetrics.in">info@hrmetrics.in</a>.</p>

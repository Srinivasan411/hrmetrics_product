                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-12">
                                    <ul className="wstliststy02 clearfix">
                                      ...
                                      <li>
                                        <a href="index.html"><span className="menu-iconn"><img alt="" src="../assets/images/icon/talent-management.png" /></span> Talent Recognition </a>
                                      </li>
                                    </ul>
                                  </div>
                                  <div className="col-lg-4 col-md-12">
          ...
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <div className="site-heading mb-0 text-center">
                <h2 className="title split-text mb-0">Empower Your HR: Unite, Engage, and Thrive</h2>
                <p className="split-text">Easily and effectively manage awards, promotions, transfers, resignations, full and final settlements, employee exits, warnings, events, birthdays, holidays, announcements, and feedback or suggestions—all in one place using the <strong>Talent Management System.</strong></p>

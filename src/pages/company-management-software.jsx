          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              <div className="site-heading mb-0 text-center">
                <h4 className="sub-title">Easily Maintain</h4>
                <h2 className="title split-text mb-0">The Organisation's Structure </h2>
                <p className="split-text"><strong>Company Management Software</strong> allows you to easily set up the company's policies, procedures, and structure. It is a solid base for your <strong>organisation management</strong> and a beautiful shelter under which

                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-12">
                                    <ul className="wstliststy02 clearfix">
                                      ...
                                      <li>
                                        <a href="index.html"><span className="menu-iconn"><img alt="" src="../assets/images/icon/meeting.png" /></span> Events and Meetings </a>
                                      </li>
                                      <li>
          ...
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <div className="site-heading mb-0 text-center">
                <h2 className="title split-text mb-0">Elevate Engagement With Events And Meetings</h2>
                <p className="split-text">With <strong>Event Management Software</strong> like HRMetricS, you can easily plan, manage, and evaluate events and meetings across your organisation. From scheduling to execution, ensure every gathering efficiently and effectively drives connection, collaboration, and meaningful outcomes.</p>

                                ...
                                <div className="row">
                                  <div className="col-lg-4 col-md-12">
                                    <ul className="wstliststy02 clearfix">
                                      ...
                                      <li>
                                        <a href="index.html"><span className="menu-iconn"><img alt="" src="../assets/images/icon/attendance.png" /></span> Attendance Management </a>
                                      </li>
                                    </ul>
                                  </div>
                                  <div className="col-lg-4 col-md-12">
          ...
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <div className="site-heading mb-0 text-center">
                <h2 className="title split-text mb-0">Seemlessly Track, Monitor, and Optimise Workforce Attendance</h2>
                <p className="split-text">The <strong>Attendance Management</strong> System by HRMetricS involves the systematic tracking, recording, and analysis of employees' work hours, including shift roster, while ensuring accurate and efficient <strong>time and attendance</strong> management of every employee.</p>
                <div className="devider" />
              </div>
            </div>
          </div>
          <div className="grid-container maincustom mt-5">

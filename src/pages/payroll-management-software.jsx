                                ...
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-12">
                                    <ul className="wstliststy02 clearfix">
                                      ...
                                      <li>
                                        <a href="index.html"><span className="menu-iconn"><img alt="" src="../assets/images/icon/payroll.png" /></span> Payroll Management </a>
                                      </li>
                                      <li>
          ...
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <div className="site-heading mb-0 text-center">
                <h2 className="title split-text mb-0">Accurate, Timely, and Hassle-free<br /> Payroll Software</h2>
                <p className="split-text">HRMetricS' <strong>Payroll Management Software</strong> is an integral part of its HRM Solution and is designed to ensure accuracy, efficiency, and statutory compliance in payroll processing.</p>

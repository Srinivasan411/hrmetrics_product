  ...
  return (
    <div>
                              ...
                              <div className="container-fluid">
                                <div className="row">
                                  ...
                                  <div className="col-lg-4 col-md-12">
                                    <ul className="wstliststy02 clearfix">
                                      <li>
                                        <a href="index.html"><span className="menu-iconn"><img alt="" src="../assets/images/icon/analytics.png" /></span>Reports and Analytics </a>
                                      </li>
                                      <li>
      ...
      <BannerStyleFourHero
        ...
        title={<>Turn <strong>HR Data Into Actionable</strong> Insights — Smarter decisions, faster outcomes</>}
        description="Get a 360° view of your workforce with customizable reports and predictive analytics. Spot trends, reduce risks, and align your people strategy with business goals—all through one intelligent HR analytics platform."
        primaryAction={
          ...
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <div className="site-heading mb-0 text-center">
                <h2 className="title split-text mb-0">Turn Workforce Data into Strategic Insight</h2>
                <p className="split-text">HRMetricS' Reports and <strong>Analytics Software</strong> provides organisations with powerful data insights to support informed decision-making. Understand workforce trends, monitor key performance indicators, and refine HR strategies to boost efficiency and productivity. Leverage HRMetricS' advanced <strong>reporting tool</strong> to drive smarter, faster decisions.</p>

...
export default function TaskManagementSoftwarePage() {
  return (
    <div>
              ...
              <div className="banner-four-bottom-info mt-3">
                <div className="row align-items-center">
                  <div className="col-md-12">
                    <div className="info">
                      <p>
                        Simplify how work gets done with HRMetricS’ Task Management solution. From one-time assignments to recurring responsibilities—plan, assign, and track everything from a single, intuitive dashboard.
                      </p>
      ...
      <div className="about-style-two-area1 default-padding overflow-hidden bg-light">
        <div className="container">
          <div className="row align-center">
            <div className="col-lg-7">
              <div className="about-style-two-info1">
                <h2 className="title split-text">Drive Productivity Through Clear Priorities and Seamless Collaboration</h2>
                <div className="list-item-style-two wow fadeInUp">
                  <div className="info ul-coustom">
                    <p>
                      HRMetricS' <strong>Task Management Software</strong> helps teams track tasks efficiently, break down complex work into subtasks, set deadlines, and collaborate with ease. With features like dashboards, project planners, performance analytics, task and bug history, real-time alerts, and seamless email integrations, managing daily workflows becomes more transparent and result-driven.
                    </p>
                    <ul className="mt-3">
            ...
            <div className="col-lg-5">
              <div className="about-style-two-thumb1">
                <img alt="Image Not Found" className="wow fadeInUp" src="../assets/images/taskmanagement.png" />
              </div>
            </div>
          </div>
        </div>
      </div>
      <section className="scrll-section hr_process_section pt-5">
        <div className="container">
          <div className="grid-container">
            <div className="box box-org">
              <a className="scrollbtnn" href="#software1">
            ...
            <div className="box box-emp ddd">
              <a className="scrollbtnn" href="#software2">
                <div className="icon-text">
            ...
            <div className="box box-access">
              <a className="scrollbtnn" href="#software7">
                <div className="icon-text">
            ...
            <div className="box box-roles">
              <a className="scrollbtnn" href="#software4">
                <div className="icon-text">
            ...
            <div className="box box-audit">
              <a className="scrollbtnn" href="#software5">
                <div className="icon-text">
            ...
            <div className="box box-hr">
              <a className="scrollbtnn" href="#software8">
                <div className="icon-text">
            ...
            <div className="box box-notif">
              <a className="scrollbtnn" href="#software3">
                <div className="icon-text">
            ...
            <div className="box box-know">
              <a className="scrollbtnn" href="#software6">
                <div className="icon-text">
            ...
            <div className="box box-know1">
              <a className="scrollbtnn" href="#software9">
                <div className="icon-text">
                  <i className="fas fa-user-check" />
      ...
      <div className="project-style-three-area mt-5" id="software1">
        <div className="container-fluid">
          <div className="project-style-three-item">
            <div className="row g-0">
              <div className="col-xl-6 col-lg-6">
                <div className="procut-img bg_1 leftbox wow fadeInUp" data-wow-delay="200ms">
                  <img alt="Image Not Found" src="../assets/images/organization.png" />
                </div>
              </div>
              <div className="col-xl-6 col-lg-6">
                <div className="project-style-three-info wow fadeInUp" data-wow-delay="200ms">
      ...
      <div className="project-style-three-area area2" id="software2">
        <div className="container-fluid">
          <div className="project-style-three-items">
            <div className="project-style-three-item">
              <div className="row g-0">
                <div className="col-xl-6 col-lg-6">
                  <div className="project-style-three-info wow fadeInUp" data-wow-delay="300ms">
                ...
                <div className="col-xl-6 col-lg-6">
                  <div className="procut-img bg_2 rightbox wow fadeInUp" data-wow-delay="300ms">
      ...
      <div className="project-style-three-area" id="software3">
        <div className="container-fluid">
          <div className="project-style-three-items">
            <div className="project-style-three-item">
              <div className="row g-0">
                <div className="col-xl-6 col-lg-6">
                  <div className="procut-img bg_3 leftbox wow fadeInUp" data-wow-delay="400ms">
                    <img alt="Image Not Found" src="../assets/images/progress-tracking.png" />
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6">
                  <div className="project-style-three-info wow fadeInUp" data-wow-delay="400ms">
        ...
        <div className="container-fluid">
          <div className="project-style-three-items">
            <div className="project-style-three-item">
              <div className="row g-0">
                <div className="col-xl-6 col-lg-6">
                  <div className="procut-img bg_3 leftbox wow fadeInUp" data-wow-delay="800ms">
                    <img alt="Image Not Found" src="../assets/images/productvity-boost.png" />
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6">
                  <div className="project-style-three-info wow fadeInUp" data-wow-delay="800ms">
              ...
              <div className="col-lg-4 col-md-6 footer-item">
                <div className="f-item link">
                  ...
                  <ul className="hr-ul">
                    ...
                    <li><a href="index.html">Task Management</a></li>
                ...
                <div className="f-item link">
                  ...
                  <ul className="mt-3 mb-3">
                    <li>
                      ...
                      <div className="working-day mb-2"><strong>Madurai:</strong>  C-20, Sector - 65, Madurai - 201301, India</div>
